...
> Design document for Gap 1: Context Compiler from the [Context Engineering Gaps Analysis](/reference/context-engineering-gaps).
...
- [Context Engineering Gaps Analysis](/reference/context-engineering-gaps)
- [Amelia Roadmap - Phase 2](/reference/roadmap#phase-2-web-dashboard-in-progress)
