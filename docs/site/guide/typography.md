...
- Explore the [Color System](/guide/color-system) for text colors
- Create [Diagrams](/guide/diagrams) with consistent fonts
- Build [Presentations](/guide/presentations) using the type scale
