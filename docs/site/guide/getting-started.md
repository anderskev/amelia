...
- Explore the [Color System](/guide/color-system) in detail
- Learn about [Typography](/guide/typography) and type scale
- Create [Diagrams](/guide/diagrams) with D2 and Mermaid
- Build [Presentations](/guide/presentations) with Slidev
