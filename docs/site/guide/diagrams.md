...
- Learn about the [Color System](/guide/color-system) for diagram colors
- Explore [Typography](/guide/typography) for diagram labels
- Create [Presentations](/guide/presentations) with embedded diagrams
