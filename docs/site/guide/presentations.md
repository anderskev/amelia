...
- Learn about the [Color System](/guide/color-system) used in the theme
- Explore [Typography](/guide/typography) for text styling
- Create [Diagrams](/guide/diagrams) to embed in slides
