...
This folder contains design documents created through collaborative brainstorming sessions using the **[superpowers:brainstorming](https://github.com/anthropics/claude-code/tree/main/plugins/superpowers) skill** in Claude Code.
